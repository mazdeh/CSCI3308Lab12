...
# As you can see, it should contain a start function to start the computer, 
# and a getComputerInfo function to get the information of the CPU, 
...
class Adapter:
    ...
    def getComputerInfo(self):
        self.com.printCPUInfo(), self.com.printMemInfo(), self.com.printHDInfo()
